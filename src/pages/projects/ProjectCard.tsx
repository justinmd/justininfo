        ...
        <div className="lg:h-[30rem] lg:mb-[2rem]">
            <div className='flex flex-col items-center h-full gap-2'>
                <a href={pageLink} target="_blank" className="cursor-pointer w-[100%] lg:w-[600px] h-auto lg:h-[300px] overflow-visible flex items-center  justify-center">
                    <img src={image} alt={`${title} — project screenshot`} className="object-contain w-[100%] lg:w-auto h-auto lg:h-[300px] mb-2 rounded-2xl shadow-md shadow-shadow-dark dark:shadow-shadow-light overflow-hidden hover:scale-105 hover:shadow-lg transition-all duration-200 ease-in-out" />
                </a>
